...
def test_expand_columns_no_expansion(
    sample_confounds_timeseries, sample_confound_columns
):
    expanded_columns: List[str] = expand_columns(
        sample_confounds_timeseries, sample_confound_columns
    )
...
def test_expand_columns_pattern_at_end(
    sample_confounds_timeseries, sample_confound_columns
):
...
def test_expand_columns_pattern_at_start(
    sample_confounds_timeseries, sample_confound_columns
):

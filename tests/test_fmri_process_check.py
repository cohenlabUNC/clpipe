...
def test_legacy_fmriprep_process_check(clpipe_legacy_fmriprep_dir):
    ...
    fmri_process_check(os.path.join(clpipe_legacy_fmriprep_dir,'clpipe_config.json'), os.path.join(clpipe_legacy_fmriprep_dir,'Checker-Output.csv'))
    assert os.path.isfile(os.path.join(clpipe_legacy_fmriprep_dir,'Checker-Output.csv'))
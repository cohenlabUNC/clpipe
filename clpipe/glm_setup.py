...
@click.option('-postproc2', is_flag=True, default=False,
              help='Use the postproc2 backend.')
def glm_setup_cli(subjects, config_file, glm_config_file, submit, batch, debug, drop_tps, postproc2):
    if postproc2:
        glm_setup_postproc2(subjects = subjects, config_file=config_file, glm_config_file = glm_config_file)
    else:

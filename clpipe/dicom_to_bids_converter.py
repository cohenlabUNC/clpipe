...
def dicom_to_nifti_to_bids_converter_setup(subject = None, session = None, configfile = None, dicomdirectory=None, outputfile=None,
    ...
    batch_manager.update_mem_usage(config.config['HeudiconvOptions']['HeudiconvMemoryUsage'])
    batch_manager.update_time(config.config['HeudiconvOptions']['HeudiconvTimeUsage'])

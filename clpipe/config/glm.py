...
DEFAULT_CONFIG_FILE_NAME = "defaultGLMConfig.json"
...
class GLMOptions:
    ...
    def __init__(self, glm_config_file: os.PathLike = None):
        ...
        if glm_config_file is None:
            ...
            with resource_stream(__name__, f'data/{DEFAULT_CONFIG_FILE_NAME}') as def_config:
    ...
    def config_json_dump(self, outputdir: os.PathLike, file_name: os.PathLike) -> os.PathLike:
        ...
        """
        file_name = DEFAULT_CONFIG_FILE_NAME if file_name is None else None
    ...
    def populate_project_paths(self, project_directory: os.PathLike) -> None:
        """Generate default project paths given a specific project root.

        Args:
            project_directory (os.PathLike): Path to the root project directory.
        """
        import os

        self.config['ParentClpipeConfig'] = os.path.join(project_directory, "clpipe_config.json")

        self.config['Level1Setups'][0]['TargetDirectory'] = os.path.join(project_directory, "data_postproc2", "default")
        ...
        self.config['Level1Setups'][0]['ConfoundDirectory'] = os.path.join(project_directory, "data_postproc2", "default")

...
@click.option('-dicom_dir', required = True, help = 'The folder where subject dicoms are located.')
@click.option('-dicom_dir_format', required = True, help = 'Format string for how subjects/sessions are organized within the dicom_dir.')
@click.option('-BIDS_dir', default = "dicom_info.tsv", help = 'The dicom info output file name.')

...
from nipype.interfaces.afni import TProject, Undump, ROIStats
...
def build_image_postprocessing_workflow(
    ...
    for index, step in enumerate(processing_steps):
        ...
        if step == STEP_TEMPORAL_FILTERING:
            ...
            hp = (
                processing_options.processing_step_options.temporal_filtering.filtering_high_pass
            )
            lp = (
                processing_options.processing_step_options.temporal_filtering.filtering_low_pass
            )
            order = (
                processing_options.processing_step_options.temporal_filtering.filtering_order
            )
            implementation_name = (
                processing_options.processing_step_options.temporal_filtering.implementation
            )
            ...
            implementation_name = (
                processing_options.processing_step_options.intensity_normalization.implementation
            )
            ...
            implementation_name = (
                processing_options.processing_step_options.spatial_smoothing.implementation
            )
            ...
            implementation_name = (
                processing_options.processing_step_options.confound_regression.implementation
            )
            ...
            trim_from_beginning = (
                processing_options.processing_step_options.trim_timepoints.from_beginning
            )
            trim_from_end = (
                processing_options.processing_step_options.trim_timepoints.from_end
            )
            ...
            reference_image = (
                processing_options.processing_step_options.resample.reference_image
            )
            ...
            insert_na = (
                processing_options.processing_step_options.scrub_timepoints.insert_na
            )
